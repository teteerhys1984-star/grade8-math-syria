...
export const lesson01 = {
  ...
  tables: [],
  extractionIssues: [
    { page: 5, location: 'سطر النشاط الأول', note: 'طريقة عرض حل باسم وهاشم صغيرة؛ الناتج الظاهر هو −4/7، أما بعض تفاصيل الصياغة الوسيطة فمُسجلة كما أمكن قراءتها.' },
    { page: 7, location: 'تحقق من فهمك، السؤال 2، البند ⑤', note: 'يحتاج ترتيب الإشارات في التعبير إلى مراجعة من صورة أصلية عالية الدقة.' },
    { page: 7, location: 'تدرب، السؤال 4', note: 'اسم العصير الأخير في السؤال يحتاج مراجعة من صورة أصلية عالية الدقة.' }
  ],
  assessment: null
};
